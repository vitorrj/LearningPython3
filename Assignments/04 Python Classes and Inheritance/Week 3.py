# EXERCISE 1
# The code below takes the list of country, country, and searches to see if it is in the dictionary
# gold which shows some countries who won gold during the Olympics. However, this code currently does not work.
...
# EXERCISE 7
# The buggy code below prints out the value of the sport in the list sport. Use try/except so that the code will
# run properly. If the sport is not in the dictionary, ppl_play, add it in with the value of 1.
...
# EXERCISE 8
# Provided is a buggy for loop that tries to accumulate some values out of some dictionaries.
# Insert a try/except so that the code passes. If the key is not there,
