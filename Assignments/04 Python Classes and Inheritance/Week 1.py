...
class Bike:
    def __init__(self, color, price):
        ...
        self.price = price
    def __str__(self):
        return "The color is {} and the price is {}".format(self.color, self.price)
...
# EXERCISE 3
# Define a class called BankAccount that accepts the name you want associated with your bank account in a string, and an integer that
# represents the amount of money in the account. The constructor should initialize two instance variables from those inputs: name and amt.
# Add a string method so that when you print an instance of BankAccount, you see "Your account, [name goes here], has [start_amt goes here] dollars."
